...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_s3"></a> [s3](#module\_s3) | git::ssh://git@github.com/FXinnovation/fx-terraform-module-aws-bucket-s3.git | 3.0.0 |
...
| Name | Description |
|------|-------------|
| <a name="output_vpc_with_policy"></a> [vpc\_with\_policy](#output\_vpc\_with\_policy) | n/a |
